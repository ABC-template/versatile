...
// ==========================================
// НАЗВАНИЯ ТЕГОВ (С КОРОТКИМИ ВЕРСИЯМИ)
// ==========================================
window.topicNames = {
    code: '#кодинг',
    creative: '#креатив',
...
// Короткие названия для фильтров в истории
...
// Полные названия для отображения (опционально)
window.topicFullNames = {
    code: 'Кодинг',
    creative: 'Креатив',
    fast: 'Флуд',
    kitchen: 'Кухня',
